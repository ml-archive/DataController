...
class DataControllerTest {
    ...
    private lateinit var mockCaller: DataSourceCaller<String>
    private lateinit var mockStorage: DataSourceStorage<String>
    ...
    fun test_callSpecific() {
        ...
        verify<DataSourceCaller<String>>(mockCaller)
